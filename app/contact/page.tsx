          ...
          <div className="bg-black p-8 hive-pattern">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <a href="https://shortstoppr.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gold transition-colors">Register at shortstoppr.com</a>
              </div>
            </div>
          </div>
